...
internal class MemberTest : FreeSpec({
    ...
    "인증을 시도했을 때 비밀번호가 일치하지 않으면 예외가 발생한다." {
        ...
        shouldThrowExactly<MemberAuthenticationException> { member.authenticate("invalid321#@!") }
    }
    ...
    "비밀번호를 변경할 수 있다." {
        ...
        shouldThrowExactly<MemberAuthenticationException> { member.authenticate("password123!@#") }
        shouldNotThrowAny { member.authenticate("newPassword321#@!") }
    }
})
